...
namespace EntityLibrary
{
    ...
    public class DatabaseAccessNonEntity
    {
        ...
        {
            string descrypt = descryptConnectionString();
        ...
        {
            //string xmlConString = string.Empty;//ConfigurationManager.ConnectionStrings["EntityLibContext"].ConnectionString;
            //string folder = HttpContext.Current.Server.MapPath("~");
            //if (File.Exists(folder + @"\App.lib"))
            //{
            //    StreamReader sr = new StreamReader(folder + @"\App.lib");
            //    while (!sr.EndOfStream)
            //    {
            //        xmlConString += sr.ReadLine().Trim();
            //    }
            //}
            //string password = "C1AC804CF71F52DB34FCEB181A59EFBD";
            //string descrypt = "";
            //return descrypt = descrypt.Replace("&quot;", "'");
            //return xmlConString.Replace("&quot;", "'");
            return @"metadata=res://*/EntityLibContext.csdl|res://*/EntityLibContext.ssdl|res://*/EntityLibContext.msl;provider=System.Data.SqlClient;provider connection string='data source=DESKTOP-J0TG6V2\SQLEXPRESS,1433;initial catalog=DOANTOTNGHIEP ;user id=sadmin;password=123456;MultipleActiveResultSets=True;App=EntityFramework'";
