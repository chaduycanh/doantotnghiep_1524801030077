!function (e) {
    ...
    i.prototype.init = function () {
        e("#basic-datepicker").flatpickr(), e("#datetime-datepicker").flatpickr({
            ...
            altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d"
            }), e("#minmax-datepicker").flatpickr({
                minDate: "2020-01", maxDate: "2020-03"
            }), e("#disable-datepicker").flatpickr({
                onReady: function () { this.jumpToDate("2025-01") }, disable: ["2025-01-10", "2025-01-21", "2025-01-30", new Date(2025, 4, 9)], dateFormat: "Y-m-d"
            }), e("#multiple-datepicker").flatpickr({
                mode: "multiple", dateFormat: "Y-m-d"
            }), e("#conjunction-datepicker").flatpickr({
                mode: "multiple", dateFormat: "Y-m-d", conjunction: " :: "
                ...
                enableTime: !0, noCalendar: !0, dateFormat: "H:i", minDate: "16:00", maxDate: "22:30"
            }), e("#preloading-timepicker").flatpickr({
                enableTime: !0, noCalendar: !0, dateFormat: "H:i", defaultDate: "01:45"
                ...
                color: "#DD0F20", inline: !0, container: !0
            }), e(".clockpicker").clockpicker({ donetext: "Done" }), e("#single-input").clockpicker({
                placement: "bottom", align: "left", autoclose: !0, default: "now"
...
}(window.jQuery), function (e) { "use strict"; e.FormPickers.init() }(window.jQuery);